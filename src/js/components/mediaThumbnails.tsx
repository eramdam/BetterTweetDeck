...
export const MediumThumbnail: FC<ThumbnailProps> = ({url, imageUrl}) => (
...
export const SmallThumbnail: FC<ThumbnailProps> = ({url, imageUrl}) => (
  <div className="js-media media-preview position-rel">
...
export const LargeThumbnail: FC<ThumbnailProps> = ({url, imageUrl}) => (
